...
describe('move', () => {
  ...
  it('throws error if list is empty', () => {
    ...
    expect(() => move(list, '3', '1')).toThrow('List is empty');
  });

  it('throws error if destination folder does not exist', () => {
    const list = [
      {
        id: '1',
        name: 'Folder 1',
    ...
    expect(() => move(list, '3', '6')).toThrow('Destination folder does not exist');
  });
  ...
  it('throws error if source file does not exist', () => {
    ...
    expect(() => move(list, '3', '6')).toThrow('Source file does not exists');
  });
});
